...
import {CreateGenreComponent} from '../create-genres/create-genres.component';
...
export class GenresFormComponent implements OnInit {
  ...
  getErrorMessagesForName(): string {
    ...
    if (field.hasError('maxlength')){
      return `The field Name must not not have mor than ${field.getError('maxlength').requiredLength} characters`;
    }
